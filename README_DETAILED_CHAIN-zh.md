...
语言：[English](README_DETAILED_CHAIN.md) | [中文](README_DETAILED_CHAIN-zh.md) | [Français](README_DETAILED_CHAIN-fr.md)

主 README：[English](README.md) | [中文](README-zh.md) | [Français](README-fr.md)
...
如果只想安装和运行，请先看 `README-zh.md`。本文更偏工程链路说明和调试记录。
