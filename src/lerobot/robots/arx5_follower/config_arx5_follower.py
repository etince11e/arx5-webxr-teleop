...
class ARX5FollowerConfig(RobotConfig):
    ...
    home_move_easing: str = "ease_in_out_quad"
    ...
    gripper_vel_max: float = 2.0
    gripper_torque_max: float = 3.0
    gripper_over_current_cnt_max: int = 120

    # Real TCP offset from the SDK/URDF eef_link, expressed in eef_link frame.
    # Calibrated by examples/arx5_tcp_four_point_calibration.py.
    tcp_offset_xyz: list[float] = field(
